                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal<?= $num ?>">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </button>
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $num ?>">
                                ...
                                <div class="modal fade" id="deleteModal<?= $num ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <form action="proses/proses_hapus_peminjaman.php.php" method="post">
                                                <input type="hidden" name="kd_brg" value="<?= $data['kode_barang'] ?>">
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin ingin menghapus data <?= $data['nama_barang'] ?>?</p>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
